...
.. image:: main/images/o2a_overview.png
...
3. The `CURC EnginFrame ("Viz") cluster <https://www.colorado.edu/rc/resources/enginframe>`_ (GPU nodes for visualizing images & using software requiring a graphical user interface, or "GUI")
...
See the `Quick Start Guide <main/index.html#span-style-color-green-quick-start-guide-span>`_ to access CURC resources via gateways.
